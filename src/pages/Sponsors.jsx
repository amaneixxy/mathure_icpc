      ...
      <section className="section" style={{ backgroundColor: 'var(--background)' }}>
        <div className="container" style={{ maxWidth: '900px' }}>
          ...
          <div className="card-plain" style={{ marginBottom: '3rem', borderTop: '4px solid var(--accent)' }}>
            <h2 className="text-center" style={{ color: 'var(--primary-navy)', marginBottom: '2rem' }}>
          ...
          {/* Call to Sponsorship */}
          <div className="card-plain text-center" style={{ borderTop: '4px solid var(--secondary-accent)' }}>
