        ...
        <div className="footer-grid">
          ...
          <div className="footer-links-col">
            ...
            <ul className="footer-links-list">
              ...
              <li><Link to="/people">Organizing Committee</Link></li>
          ...
          {/* Quick Links Column 3: External Resources */}
          <div className="footer-links-col">
            <h4>External</h4>
            <ul className="footer-links-list">
              <li>
              ...
              <li>
                <a href="https://blog.icpc.global" target="_blank" rel="noopener noreferrer">
                  ICPC Asia Blog
                </a>
              </li>
              <li>
